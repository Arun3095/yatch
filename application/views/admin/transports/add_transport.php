	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-8">
				...
				<a href="<?=base_url()?>admin/Transport"><button type="button" class="btn btn-primary">View Transport List</button></a>
				<div class="card">
					<div class="card-header card-header-primary">
						<h4 class="card-title">Transport Detail</h4>
						<p class="card-category">Add Transport Detail</p>
					</div>
					<div class="card-body">
						<form method="post" action="<?=base_url()?>admin/Transport/add" enctype="multipart/form-data">
							<div class="row">
								<div class="col-md-12">
