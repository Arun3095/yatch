	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-8">
				...
				<a href="<?=base_url()?>admin/Slide"><button type="button" class="btn btn-primary">View Slides List</button></a>
				<div class="card">
					<div class="card-header card-header-primary">
						<h4 class="card-title">Slides Detail</h4>
						<p class="card-category">Add Slides Detail</p>
					</div>
					<div class="card-body">
						<form method="post" action="<?=base_url()?>admin/Slide/add" enctype="multipart/form-data">
							<div class="row">
								<div class="col-md-12">
